    ...
    mockQuestions.forEach((q, index) => {
        container.innerHTML += `
            <div class="card test-question">
                ...
                <label><input type="radio" name="question${q.id}" value="A"> ${q.optionA}</label>
                <label><input type="radio" name="question${q.id}" value="B"> ${q.optionB}</label>
                <label><input type="radio" name="question${q.id}" value="C"> ${q.optionC}</label>
                <label><input type="radio" name="question${q.id}" value="D"> ${q.optionD}</label>
            </div>
        `;
    });
}
